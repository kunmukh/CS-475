...
int main ()  // no command line arguments
{
   ...
   cout << " Timer 1: Input a time that the clock will 
be set to in one line e.g: 2 58. The clock will be set 
to 2 minutes  58 seconds "  << endl;
   
   cin >> minutes >> seconds;
   t1.Initialize(minutes, seconds);

   cout << "Timer 2: Input a time that the 
clock will be set to in one line e.g: 2 58. 
The clock will be set to 2 minutes 58 seconds" << endl;
